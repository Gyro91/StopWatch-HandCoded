 ...
 **************************************************************************/
    ...
    #define TaskControl 0
    #define TaskAlarmMNG 1
    #define TaskTC 2
    #define TaskLCD 3
    ...
    #define AlarmTaskMNG 1U
    #define AlarmTaskControl 2U
    #define AlarmTaskTC 3U
 ...
 *
 **************************************************************************/
    #define EE_ACTION_ROM_SIZE 4
    #define EE_ALARM_ROM_SIZE 4
    #define EE_COUNTER_OBJECTS_ROM_SIZE 4
