 ...
 **************************************************************************/
    ...
    DeclareTask(TaskAlarmMNG);
    DeclareTask(TaskTC);
    DeclareTask(TaskLCD);

    const EE_THREAD_PTR EE_hal_thread_body[EE_MAX_TASK] = {
        &EE_oo_thread_stub,		 /* thread TaskControl */
        &EE_oo_thread_stub,		 /* thread TaskAlarmMNG */
        &EE_oo_thread_stub,		 /* thread TaskTC */
    ...
    const EE_TYPEPRIO EE_th_ready_prio[EE_MAX_TASK] = {
        0x8U,		 /* thread TaskControl */
        0x2U,		 /* thread TaskAlarmMNG */
        0x4U,		 /* thread TaskTC */
        0x1U 		 /* thread TaskLCD */
    };
 ...
 **************************************************************************/
    const EE_oo_counter_object_ROM_type   EE_oo_counter_object_ROM[EE_COUNTER_OBJECTS_ROM_SIZE] = {
        ...
        {myCounter, AlarmTaskMNG, EE_ALARM },
        {myCounter, AlarmTaskControl, EE_ALARM },
        {myCounter, AlarmTaskTC, EE_ALARM }
    };
 ...
 **************************************************************************/
    const EE_oo_action_ROM_type   EE_oo_action_ROM[EE_ACTION_ROM_SIZE] = {
        ...
        {EE_ACTION_TASK    , TaskAlarmMNG, (EE_VOID_CALLBACK)NULL, (EE_TYPECOUNTER)-1 },
        {EE_ACTION_TASK    , TaskControl, (EE_VOID_CALLBACK)NULL, (EE_TYPECOUNTER)-1 },
        {EE_ACTION_TASK    , TaskTC, (EE_VOID_CALLBACK)NULL, (EE_TYPECOUNTER)-1 }
    };
